...
public class RequestFormTest{
	...
	int expectedFVValue = 16;
	int expectedGrainValue = 28;
	int expectedProteinValue = 26;
	int expectedOtherValue = 30;
	int expectedCalorieValue = 2500;
	...
	@Test
		...
		var clientValues = [expectedFVValue, expectedGrainValue, expectedProteinValue, expectedOtherValue];
